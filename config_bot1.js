...
config.s1 = { pin: 11, min: 10, max: 101, rangeMin: 0, rangeMax: 90};
config.s2 = { pin: 9, min: 0, max: 98, rangeMin: 0, rangeMax: 90 };
config.s3 = { pin: 10, min: 13, max: 90, rangeMin: 0, rangeMax: 90 };
