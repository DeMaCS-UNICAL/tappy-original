...
/*
    ...
    TODO: avoid the three points are aligned (otherwise the interpolation matrix will not be invertible)
*/
...
method.getPositionForScreenCoordinates = function(x, y) {
    ...
    console.log("PX", planeCoefficientsX);
    console.log("PY", planeCoefficientsY);
    console.log("PZ", planeCoefficientsZ);
    ...
    //var newX = calData.closestPoint.position.x;
    //var newY = calData.closestPoint.position.y;
    console.log("NX", newX);
    console.log("NY", newY);
    console.log("NZ", newZ);
...
//    var touchZ = this.getContactZ();
	...
	console.log("Moving at position "+position.x+" "+position.y);
        return setTimeout(function() {
...
method.swipe = function(startX, startY, endX, endY, cb) {
    ...
    //var touchZ = this.getContactZ();
    //this.setPosition(startPosition.x, startPosition.y, startPosition.z * 0.9);
    ...
    return setTimeout(function() {
        ...
        return setTimeout(function() {
            ...
            return setTimeout(function() {
//                this.setPosition(endPosition.x, endPosition.y, endPosition.z * 0.9);
