...
var delay = 400 / steps;
var child_exec;
function Robot(servo1, servo2, servo3, calibrationFile, k, config, version) {
...
method.getAngles = function() {
    if(this.version == "v2"){
        return [
            mapNumber(this._servo1.last(), this._config.s1.min, this._config.s1.max, this._config.s1.rangeMin, this._config.s1.rangeMax),
            mapNumber(this._servo2.last(), this._config.s2.min, this._config.s2.max, this._config.s2.rangeMin, this._config.s2.rangeMax),
            mapNumber(this._servo3.last(), this._config.s3.min, this._config.s3.max, this._config.s3.rangeMin, this._config.s3.rangeMax),
        ]
    }
...
method.setAngles = function(t1, t2, t3) {
    ...
    this._servo1.to(Math.round(t1));
    this._servo2.to(Math.round(t2));
    this._servo3.to(Math.round(t3));
