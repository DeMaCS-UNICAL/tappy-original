...
function Kinematics(args) {
    //Side of end effector (lowermost triangle holding the pen)
    this.e = 0;

    //Side of top triangle (motor axes in the middle of each triangle side)  
    this.f = 0;

    //Length of parallelogram joint
    this.re = 0;

    //Length of upper joint (distance between motor axis and parallelogram)
    this.rf = 0;
    ...
    console.log("Kinematics initialized with e: " + this.e + " f: " + this.f + " re: " + this.re + " rf: " + this.rf);
}
